...
resource "dbtcloud_project" "dbt_project" {
  name = "My Test project for repository"
}

resource "dbtcloud_project" "dbt_project2" {
  name = "My Other project for repository"
}
...
resource "dbtcloud_environment" "snowflake_env" {
  name        = "My Snowflake Dev Environment"
  project_id  = dbtcloud_project.dbt_project.id
  type = "deployment"
  dbt_version = "latest"
...
resource "dbtcloud_environment" "bq_env" {
  name        = "My BigQuery Dev Environment"
  project_id  = dbtcloud_project.dbt_project.id
  type = "deployment"
  dbt_version = "latest"
...
resource "dbtcloud_environment" "redshift_env" {
  name        = "My Redshift Dev Environment"
  project_id  = dbtcloud_project.dbt_project.id
  type = "deployment"
  dbt_version = "latest"
...
resource "dbtcloud_environment" "apache_spark_env" {
  name        = "My Apache Spark Dev Environment"
  project_id  = dbtcloud_project.dbt_project.id
  type = "deployment"
  dbt_version = "latest"
...
resource "dbtcloud_environment" "athena_env" {
  name        = "My Athena Dev Environment"
  project_id  = dbtcloud_project.dbt_project.id
  type = "deployment"
  dbt_version = "latest"
...
resource "dbtcloud_environment" "databricks_env" {
  name        = "My Databricks Dev Environment"
  project_id  = dbtcloud_project.dbt_project.id
  type = "deployment"
  dbt_version = "latest"
...
resource "dbtcloud_environment" "fabric_env" {
  name        = "My Fabric Dev Environment"
    project_id  = dbtcloud_project.dbt_project.id
    type = "deployment"
    dbt_version = "latest"
...
resource "dbtcloud_environment" "fabric_env_serv_princ" {
  name        = "My Fabric Dev Environment (Service Principal)"
    project_id  = dbtcloud_project.dbt_project.id
    type = "deployment"
    dbt_version = "latest"
    connection_id = dbtcloud_global_connection.fabric.id
...
resource "dbtcloud_environment" "postgres_env" {
  name        = "My PostgreSQL Dev Environment"
  project_id  = dbtcloud_project.dbt_project.id
    type = "deployment"
    dbt_version = "latest"
...
resource "dbtcloud_environment" "starburst_env" {
  name        = "My Starburst Dev Environment"
  project_id  = dbtcloud_project.dbt_project.id
  type = "deployment"
  dbt_version = "latest"
...
resource "dbtcloud_environment" "synapse_env" {
  name        = "My Synapse Dev Environment"
  project_id  = dbtcloud_project.dbt_project.id
  type = "deployment"
  dbt_version = "latest"
...
resource "dbtcloud_environment" "teradata_env" {
  name        = "My Teradata Dev Environment"
  project_id  = dbtcloud_project.dbt_project.id
    type = "deployment"
    dbt_version = "latest"

...
func TestAccDbtCloudSalesforceCredentialResource(t *testing.T) {
	...
	schema := strings.ToLower(acctest.RandStringFromCharSet(10, acctest.CharSetAlpha))
	schema2 := strings.ToLower(acctest.RandStringFromCharSet(10, acctest.CharSetAlpha))
...
func testAccDbtCloudSalesforceCredentialResourceConfig(
	projectName, connectionName, username, clientID, privateKey, schema string,
) string {
	return fmt.Sprintf(`
...
`, projectName, connectionName, username, clientID, privateKey, schema)
}

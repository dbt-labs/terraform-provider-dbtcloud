...
func TestAccDbtCloudAzureDevOpsProject(t *testing.T) {
	...
	t.Skip("Skipping AzureDevOps Project in dbt Cloud CI. This test cannot be run without ADO integration. We also cannot use a ServiceToken, which is the only token available in dbt Cloud CI.")

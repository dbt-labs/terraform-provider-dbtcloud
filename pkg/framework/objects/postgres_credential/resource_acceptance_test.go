...
func TestPostgresCredential_UpdateBugRegression(t *testing.T) {
	...
	accountID, projectID, credentialID := int64(12345), int64(67890), int64(111)
...
func updatePostgresCredentialHandlers(handlers map[string]MockEndpointHandler, accountID, projectID, credentialID int64, tracker *APICallTracker) {

...
var (
	_ datasource.DataSource              = &postgresCredentialDataSource{}
	_ datasource.DataSourceWithConfigure = &postgresCredentialDataSource{}
)

func PostgresCredentialDataSource() datasource.DataSource {
	return &postgresCredentialDataSource{}
}

type postgresCredentialDataSource struct {
	client *dbt_cloud.Client
}

func (p *postgresCredentialDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (p *postgresCredentialDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_postgres_credential"
}

func (p *postgresCredentialDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var state PostgresCredentialDataSourceModel
...
func (p *postgresCredentialDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {

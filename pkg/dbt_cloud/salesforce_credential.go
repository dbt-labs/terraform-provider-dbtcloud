...
func GenerateSalesforceCredentialDetails(
	...
	"fields": {
      ...
      "schema": {
        "metadata": {
          "label": "Schema",
          "description": "In development, dbt will build your models into a schema with this name.",
          "field_type": "text",
          "encrypt": false,
          "overrideable": false,
          "validation": {
...
`
	...
	credentialDetails := AdapterCredentialDetails{
		...
		Field_Order: []string{"username", "client_id", "private_key", "schema", "target_name", "threads"},
	}
